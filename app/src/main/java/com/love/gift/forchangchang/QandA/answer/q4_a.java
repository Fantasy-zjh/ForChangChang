...
import com.love.gift.forchangchang.QandA.question.q4;
...
public class q4_a extends AppCompatActivity {
    public static q4_a instance = null;
    ...
    private void initSnow() {
        ...
        builder = new FallObject.Builder(getResources().getDrawable(R.drawable.ic_flower));
        fallObject = builder
                .setSpeed(4, true)
                .setSize(50, 50, true)
                .setWind(5, true, true)
    ...
    public boolean onTouchEvent(MotionEvent event) {
        Intent intent = new Intent(q4_a.this, com.love.gift.forchangchang.QandA.question.q5.class);
