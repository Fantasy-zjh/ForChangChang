package com.love.gift.forchangchang.puzzlegame.ui;
...
import com.love.gift.forchangchang.puzzlegame.Utils.Utils;
import com.love.gift.forchangchang.puzzlegame.module.ImagePiece;
...
public class PuzzleLayout extends FrameLayout implements View.OnClickListener{
    ...
    private int res = R.drawable.image2;
...
//        final int secondIndex = mImagePieces.get(mFirst.getId()).getIndex();
    ...
    public void clear(){
        for(int i=0;i<mImagePieces.size();i++){
            mImagePieces.get(i).setBitmap(null);
        }
        mBitmap=null;
        mAnimLayout=null;
    }
