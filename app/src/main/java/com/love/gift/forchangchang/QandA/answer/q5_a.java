...
import com.love.gift.forchangchang.QandA.question.q5;
...
public class q5_a extends AppCompatActivity {
    public static q5_a instance = null;
    ...
    private void initSnow() {
        ...
        builder = new FallObject.Builder(getResources().getDrawable(R.drawable.ic_sun));
        fallObject = builder
                .setSpeed(4, true)
                .setSize(50, 50, true)
                .setWind(5, true, true)
    ...
    public boolean onTouchEvent(MotionEvent event) {
        Intent intent = new Intent(q5_a.this, com.love.gift.forchangchang.QandA.question.q6.class);
