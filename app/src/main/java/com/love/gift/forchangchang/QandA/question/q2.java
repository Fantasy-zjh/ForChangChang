...
public class q2 extends AppCompatActivity implements PuzzleGame.GameStateListener {
    public static q2 instance=null;
    ...
    private void initView() {
        ...
        puzzleLayout.changeRes(R.drawable.tianjin);
    ...
    public void gameSuccess(int level) {
        Toast toast=Toast.makeText(this, "天津之旅", Toast.LENGTH_SHORT);
        toast.setGravity(Gravity.CENTER,0,0);
        toast.show();
        final Intent intent=new Intent(q2.this,q2_a.class);
