...
public class q3_a extends AppCompatActivity {
    public static q3_a instance=null;
    ...
    private void initSnow() {
        ...
        builder = new FallObject.Builder(getResources().getDrawable(R.drawable.ic_heart));
        fallObject = builder
                .setSpeed(4,true)
                .setSize(50,50,true)
                .setWind(5,true,true)
    ...
    public boolean onTouchEvent(MotionEvent event) {
        Intent intent = new Intent(q3_a.this, com.love.gift.forchangchang.QandA.question.q4.class);
